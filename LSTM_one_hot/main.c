...
int RNN_model_training_example() {
	...
	*/
	...
	train_set = read_compact_set_from_file(test_file);
...
int RNN_model_import_example() {
	...
	*/
	printf("Working on testing file...\n");
	DataSet_t *train_set = read_compact_set_from_file(test_file);
